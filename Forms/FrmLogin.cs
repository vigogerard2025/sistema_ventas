	...
	public class FrmLogin : Form
	{
		...
		private void InicializarComponentes()
		{
			...
			pnlDerecho = new Panel
			{
				...
				BackColor = Color.FromArgb(15, 23, 42)   // azul marino profundo
			};
			...
			var lblBadge = new Label
			{
				...
				Location = new Point((345 - 130) / 2, 142),   // centrado
				TextAlign = ContentAlignment.MiddleCenter
			};
			...
			var lblRightTitle = new Label
			{
				...
				BackColor = Color.Transparent,
				AutoSize = false,
				Size = new Size(295, 82),
				Location = new Point((345 - 295) / 2, 180),   // centrado
				TextAlign = ContentAlignment.MiddleCenter
			...
			var lblRightSub = new Label
			{
				...
				BackColor = Color.Transparent,
				AutoSize = false,
				Size = new Size(275, 44),
				Location = new Point((345 - 275) / 2, 272),   // centrado
				TextAlign = ContentAlignment.MiddleCenter
			};

			// Feature chips
			int chipW = 220;
			int chipX = (345 - chipW) / 2;   // centrado horizontal = 62
			int fy = 400;
								...
								("💰", "Reportes financieros") })
			{
				var chip = new Label
				{
					...
					Location = new Point(chipX, fy),   // <-- usa fy, no valor fijo
					TextAlign = ContentAlignment.MiddleLeft
				};
			...
			lblCopyright = new Label
			{
				...
				Location = new Point((345 - 295) / 2, 548),   // centrado
				TextAlign = ContentAlignment.MiddleCenter
			};
